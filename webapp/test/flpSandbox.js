		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Plantilla Elemento PEP",
									"targetURL": "#aipzplelempep-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aipzplelempep-display": {
								"semanticObject": "aipzplelempep",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aip.zplelempep",
									"url": sap.ui.require.toUrl("aip/zplelempep")
								}
							}
						}
					}
